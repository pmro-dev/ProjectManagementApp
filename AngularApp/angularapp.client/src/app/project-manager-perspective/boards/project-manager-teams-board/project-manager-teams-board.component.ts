...
export class ProjectManagerTeamsBoardComponent {
  Teams: Array<Team>;
  avatarPath: string;
  borderColor: string = "var(--green) var(--green) rgb(247, 247, 247) rgb(247, 247, 247)";
  ...
  constructor() {
    ...
    this.Teams = [
      ...
      {
        Name: "Filantropia",
        Members: [{ FullName: "Jan Kowalski", Position: "UX Designer", Color : "rgb(212, 178, 45)" }, { FullName: "Joanna Kowalska", Position: "HR", Color : "rgb(145, 67, 250)" }, { FullName: "Joanna Kowalska", Position: "Front-end Developer", Color : "rgb(255, 216, 187)" }, { FullName: "Joanna Kowalska", Position: "Technical Lider", Color : "rgb(255, 216, 15)" }, { FullName: "Joanna Kowalska", Position: "Analytic", Color : "rgb(255, 16, 187)" }],
