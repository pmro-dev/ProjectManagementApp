...
{
	public static class AccountDtoService
	{
		public static LoginInputDto TransferToLoginInputDto(LoginInputVM loginInputVM)
		{
		...
		public static UserDto TransferToUserDto(RegisterInputVM registerInputVM)
		{
			return new UserDto
			{
				UserId = string.Empty,
		...
		public static UserDto TransferToUserDto(UserModel userModel)
		{
			return new UserDto
			{
		...
		public static UserModel TransferToUserModel(UserDto userDto)
		{
		...
		public static UserModel TransferToUserModel(LoginInputDto loginInputDto)
		{
