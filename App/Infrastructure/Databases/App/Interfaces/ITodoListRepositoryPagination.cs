...
{
	Task<TodoListModel?> GetSingleWithDetailsAsync(Guid todoListId, Expression<Func<TaskModel, object>> orderDetailsBySelector, int pageNumber, int itemsPerPageCount);
